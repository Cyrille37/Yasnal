...
<body>
	...
	<div>
		Authenticated as <span id="demo-auth"></span> <input type="button" value="Refresh" onclick="update_auth()" /> <input
			type="button" value="Log out" onclick="logout()" />
	</div>
	...
	<div id="demo-auth-form">
		<div id="auth-form">
			<form title="Social Network Authentification">
				...
				<ul class="services">
					<li><a href="" title="identifiez vous avec Google+" class="auth-google-button"><img alt="Google"
							src="<?php echo YASNAL_URI,'/img/google_32.png' ?>" /> </a></li>
					<li><a href="" title="identifiez vous avec Facebook" class="auth-facebook-button"><img alt="Facebook"
							src="<?php echo YASNAL_URI,'/img/facebook_32.png' ?>" /> </a></li>
					<li><a href="" title="identifiez vous avec un email" class="auth-email-button"><img alt="eMail"
		...
		<div id="auth-form-email">
			<form title="Email Authentification">
				...
				<p>
					Votre adresse email: <input type="text" name="auth-email" size="30" /> <input type="button" value="Envoyer le code"
						class="auth-email-send" /> <input type="button" value="Annuler" class="auth-email-cancel" />
				</p>
			</form>
		</div>
		<div id="auth-form-email-code">
			<form title="Social Authentification">
				<p>
					Indiquer le code que vous avez reçu à l'adresse email <span id="auth-email"></span>
				</p>
				<p>
					Le code: <input type="text" name="auth-emailCode" size="10" /> <input type="button" value="Valider"
						class="auth-emailCode-confirm" /> <input type="button" value="Annuler" class="auth-emailCode-cancel" />
				</p>
			</form>
		</div>
		<div id="auth-error">
